...
function SubscriptionPage() {
  ...
  return (
    <Container
      maxWidth="lg"
      sx={{ mt: 6, mb: 6, direction: isRTL ? 'rtl' : 'ltr' }}
    >
      <Typography variant="h3" align="center" gutterBottom fontWeight="bold">
            ...
            <Grid item xs={12} sm={6} md={4} lg={3} key={sub.id}>
              <Card
                ...
                sx={{
                  ...
                  '&:hover': {
                    transform: isCurrentSubscription ? 'none' : 'scale(1.05)',
                    boxShadow: isCurrentSubscription
                      ? 'none'
              ...
              >
                ...
                <CardContent>
                  ...
                  <Box mt={2}>
                    <Typography variant="body2" color="text.primary">
                      🏠 <strong>{t('subscription.properties')}:</strong> {sub.propertyNumber}
                    </Typography>
                    <Typography variant="body2" color="text.primary">
                      🚀 <strong>{t('subscription.promotions')}:</strong> {sub.numberOfPromotion}
                    </Typography>
                    <Typography variant="body2" color="text.primary">
                      ⏳ <strong>{t('subscription.duration')}:</strong> {sub.duration}
                    </Typography>
                  </Box>
                </CardContent>
                ...
                <CardActions sx={{ mt: 'auto', justifyContent: 'center', mb: 2 }}>
                  <Tooltip
                    title={
                      isCurrentSubscription
                        ? t('subscription.tooltip.current')
                        : t('subscription.tooltip.activate')
                    }
                  >
                    <span>
                      <Button
                      ...
                      >
                        {isCurrentSubscription
                          ? t('subscription.button.current')
                          : t('subscription.button.subscribe')}
                      </Button>
                    </span>
                  </Tooltip>
                </CardActions>
