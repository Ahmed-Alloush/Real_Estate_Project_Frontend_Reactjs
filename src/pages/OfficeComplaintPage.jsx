...
import {
  getOfficeComplaintForUser,
  deleteOfficeComplaint,
} from "../redux/superAdmin/manageOfficeComplaintSlice"; // Adjust the import path as needed

function OfficeComplaintPage() {
  const dispatch = useDispatch();
  const { complaints, loading, error } = useSelector(
    (state) => state.officeComplaint
  );
  ...
  useEffect(() => {
    dispatch(getOfficeComplaintForUser());
  }, [dispatch]);
            ...
            <Grid item xs={12} sm={6} md={4} key={complaint.id}>
              ...
              >
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Typography color="text.secondary" gutterBottom>
                    Office : {complaint.office?.name || "N/A"}
                  </Typography>
                  <Typography
                    variant="body2"
                    paragraph
          ...
          <DialogContent dividers>
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                ...
                <Typography variant="subtitle1" component="h4" gutterBottom>
                  Office : {selectedComplaint.office?.name || "N/A"}
                </Typography>
                <Typography variant="subtitle1" component="h4" gutterBottom>
...
export default OfficeComplaintPage;
