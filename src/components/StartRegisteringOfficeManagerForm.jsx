...
// import { startRegisterByEmailPhoneAsOfficeManager } from "../features/auth/startRegisterSlice";
// import {
//   Box,
//   TextField,
//   Button,
...
// export default function StartRegisteringOfficeManagerForm() {
...
//     dispatch(
//       startRegisterByEmailPhoneAsOfficeManager({
//         email,
...
import { useEffect, useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import { startRegisterByEmailPhoneAsOfficeManager } from "../redux/auth/authSlice";
import {
  Box,
  TextField,
  Button,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Register to manage your office properties
        </Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
