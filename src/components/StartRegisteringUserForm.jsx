    ...
    >
      ...
      >
        ...
        <Typography
          ...
          color="text.secondary"
        >
          {t("userSignupForm.subtitle")}
        </Typography>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <TextField
                label={t("userSignupForm.emailLabel")}
                variant="outlined"
                type="email"
                fullWidth
                required
            ...
            <Grid item xs={4}>
              <FormControl fullWidth>
                <InputLabel id="country-code-label">
                  {t("userSignupForm.codeLabel")}
                </InputLabel>
                <Select
                  labelId="country-code-label"
                  value={countryCode}
                  label={t("userSignupForm.codeLabel")}
                  onChange={(e) => setCountryCode(e.target.value)}
                >
                  <MenuItem value="+963">+963 ({t("userSignupForm.countryCodes.syria")})</MenuItem>
                  <MenuItem value="+1">+1 ({t("userSignupForm.countryCodes.us")})</MenuItem>
                  <MenuItem value="+44">+44 ({t("userSignupForm.countryCodes.uk")})</MenuItem>
                  <MenuItem value="+971">+971 ({t("userSignupForm.countryCodes.uae")})</MenuItem>
                  <MenuItem value="+49">+49 ({t("userSignupForm.countryCodes.germany")})</MenuItem>
                  <MenuItem value="+33">+33 ({t("userSignupForm.countryCodes.france")})</MenuItem>
                  <MenuItem value="+90">+90 ({t("userSignupForm.countryCodes.turkey")})</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={8}>
              <TextField
                label={t("userSignupForm.phoneLabel")}
                variant="outlined"
                type="tel"
                fullWidth
                required
            ...
            <Grid item xs={12}>
              ...
              >
                {loading ? (
                  ...
                  t("userSignupForm.registerButton")
                )}
              </Button>
            </Grid>
          </Grid>
